...
return [
    /*
     |--------------------------------------------------------------------------
     | CUSTOM: OAuth Encryption Key
     |--------------------------------------------------------------------------
     |
     | This is the plain-text encryption key used when creating refresh tokens.
     | It may be generated by running `vendor/bin/generate-defuse-key`.
     |
     */

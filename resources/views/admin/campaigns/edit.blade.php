...
@section('header_content')
    @include('admin.layouts.header', ['title' => 'Edit Campaign'])
@endsection
    ...
    <div class="container -padded">
        <div class="wrapper">
            <div class="container__block -narrow">
                <form method="post" enctype="application/x-www-form-urlencoded" action="{{ route('admin.campaigns.update', $campaign) }}">
                    {{ csrf_field()}}
